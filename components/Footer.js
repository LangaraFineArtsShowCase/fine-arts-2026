  ...
  return (
    <footer className={styles.siteFooter}>
      <div className={styles.wrapper}>
        <div>
          <h3>Fine Arts Grad Show 2026</h3>
          <ul>
            <li>
        ...
        <div>
          ...
          <ul className={styles.socialIcons}>
            <li>
              <Link
                href="https://www.instagram.com/langarafineart/?hl=en"
                target="_blank"
                title="Instagram"
              >
                <svg
            ...
            <li>
              <Link
                href="https://www.facebook.com/langarafinearts/"
                target="_blank"
                title="Facebook"
              >
                <svg
        ...
        <div className={styles.howToApplyWrapper}>
          <h3>How to Apply</h3>
          <div className={styles.howToApply}>
            ...
            <div>
              <p>
                Learn all about our Fine Arts program, admissions, career paths,
                and more on our program&apos;s website.
              </p>
              <p>
                <Link
                  href="https://langara.ca/programs-and-courses/programs/fine-arts/application-info.html"
                  target="_blank"
                  className={styles.footerApplyLink}
                >
                  Department of Fine Arts <TopRightArrow />
                </Link>
              </p>
            </div>
          </div>
