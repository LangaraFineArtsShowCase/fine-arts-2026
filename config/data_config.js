...
export const studioArray = [
  {
    ...
    studioSlug: 'ceramics',
    studioDescription:
      'Ceramics courses at Langara offer students foundational techniques in clay that allow for the development of a range of forms, from functional objects to multimedia sculptures. Students explore a variety of hand building techniques, mold making and wheel throwing to create functional, decorative, and sculptural forms. They learn to fire work in a variety of kilns, temperatures, and atmospheres (raku, gas and electric). They make slips and glazes and experiment with a myriad of surface embellishments including printing on clay. Conceptual development and personal research is supported by presentations, reading groups and discussions that help each student develop their practice. Upon completion of the Langara Ceramics Program students are able to situate their practice within the arc of historical and contemporary ceramics making.',
    studioFaculty: ['Alwyn O’Brien', 'Gloria Han'],
    studioImage: [
  ...
  },
  {
    ...
    fallbackImages: [
      `${imageBasePath}/images/studios/fallbacks/carving/01Carving.jpg`,
      `${imageBasePath}/images/studios/fallbacks/carving/02Carving.jpg`,
      `${imageBasePath}/images/studios/fallbacks/carving/03Carving.jpg`,
      `${imageBasePath}/images/studios/fallbacks/carving/04Carving.jpg`,
      `${imageBasePath}/images/studios/fallbacks/carving/05Carving.jpg`,
    ],
  },
  {
    studioID: 5,
  ...
  },
  {
    ...
    fallbackImages: [
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_1.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_2.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_3.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_4.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_5.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_6.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_7.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_8.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_9.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_10.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_11.jpg`,
      `${imageBasePath}/images/studios/fallbacks/performance/Performance_StudioPage_12.jpg`,
    ],
  },
  {
    studioID: 8,
  ...
  },
  {
    ...
    studioDescription:
      'Sculpture courses introduce students to traditional and contemporary approaches to three-dimensional form. Students gain hands-on experience with a variety of processes that include working with wood, stone carving, metal fabrication, body casting, mold making and the use of synthetics and flexible materials. Experimentation with found objects and the investigation of chosen materials for independent projects is also explored. In our sculpture courses, students develop their practice on both a conceptual and technical level, implementing a critical approach to materiality and three-dimensional form.',
    studioFaculty: [
      'Steven Hubert',
      'Scott Kemp',
      'Natalie Purschwitz',
